      ...
      <div className="container px-6 py-12 mx-auto">
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
          ...
          <div className="p-4 py-6 rounded-lg bg-gray-50 dark:bg-gray-800 md:p-8">
            ...
            <button onClick={formSubmite} className="w-full px-6 py-3 mt-4 text-lg font-medium tracking-wide text-white capitalize rounded-full transition-colors duration-300 transform bg-primery">
              Send message
            </button>
